    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10 text-center">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-4 text-foreground">
          <span className="text-ado-key">A fan web</span> for Japan's Vocal Powerhouse
        </h1>
        <p className="text-xl md:text-2xl max-w-3xl mx-auto text-accent-foreground">
          This fan-made site celebrates the incredible talent and artistry of Ado, whose music has touched millions of
          hearts worldwide.
        </p>
      </div>
    </section>
